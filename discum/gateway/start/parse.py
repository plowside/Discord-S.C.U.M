...
class StartParse(object): #really hope this doesn't take too long to run...
	...
	def ready(response):
		try:
			...
			if 'user_settings' not in ready_data: ready_data['user_settings'] = {}
		...
		except Exception as e: print('zxcccccccccccccccccccccccccc', traceback.extract_tb(e.__traceback__)[-1].lineno, type(e), e)
		return ready_data
